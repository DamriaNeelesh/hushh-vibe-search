            ...
            <VStack align="start" spacing={3}>
              ...
              >
                <ListItem cursor={"pointer"}>
                  <Link to="introduction" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Introduction
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
  <Link to="information-collect" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}> 
    Information We Collect
  </Link>
  <UnorderedList styleType="circle" pl={4}>
    <ListItem cursor={"pointer"}>
      <Link to="information-you-provide" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
        Information You Provide
      </Link>
    </ListItem>
    <ListItem cursor={"pointer"}>
      <Link to="information-collected-automatically" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
        Information Collected Automatically
      </Link>
    </ListItem>
  </UnorderedList>
                ...
                <ListItem cursor={"pointer"}>
                  <Link to="how-we-use" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    How We Use Your Information
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="sharing-info" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Sharing Your Information
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="privacy-choices" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Your Privacy Choices
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="data-security" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Data Security
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="children-privacy" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Children's Privacy
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="changes-policy" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Changes to this Privacy Policy
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="contact-us" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Contact Us
                  </Link>
                </ListItem>
                <ListItem cursor={"pointer"}>
                  <Link to="links-policies" smooth offset={-headerHeight} onClick={() => handleLinkClick("introduction")}>
                    Links to Hushone Policies
                  </Link>
                </ListItem>
              </UnorderedList>
